...
<form id="data-form" class="row g-2 my-3">
    <input class="form-control" type="text" id="choferInicial" name="choferInicial" placeholder="Chofer Inicial" aria-label="Chofer Inicial" />
    ...
    <input class="form-control" type="text" id="nombreUsuario" name="nombreUsuario" placeholder="Nombre Chofer" aria-label="Nombre Chofer" list="choferes" />
    ...
    <input class="form-control" type="number" name="filtrar" id="filtrar" value="<?php echo (isset($_GET['filtrar']) && $_GET['filtrar'] > 0) ? $_GET['filtrar'] : ''; ?>" placeholder="Filtrar por cualquier número" />
